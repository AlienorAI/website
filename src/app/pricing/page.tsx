...
import {
    CalendarIcon,
    CheckIcon,
    ChevronUpDownIcon, EnvelopeIcon,
    MinusIcon, RocketLaunchIcon,
...
const tiers = [
  {
    ...
    slug: 'alienor',
    description: 'Idéal pour les entrepreneurs qui souhaitent intégrer l\'IA à leur quotidien professionnel.',
    priceMonthly: 149,
    href: '#',
    highlights: [
  ...
  },
  {
    ...
    slug: 'pro',
      popular: true,
    description: 'Conçu pour les entreprises qui recherchent performance et sécurité sans compromis.',
    priceMonthly: 249,
    href: '#',
    highlights: [
  ...
  },
  {
    ...
    slug: 'business',
    description: 'Spécialement développé pour les secteurs sensibles avec une infrastructure dédiée.',
    priceMonthly: 349,
    href: '#',
    highlights: [
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
          Trois formules conçues pour répondre à vos besoins de sécurité et de performance. Commencez votre essai gratuit dès aujourd'hui.
      </Lead>
    </Container>
  )
}
...
function PricingCard({ tier }: { tier: (typeof tiers)[number] }) {
  return (
    <div className="-m-2 grid grid-cols-1 rounded-2xl  max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="grid grid-cols-1 rounded-2xl relative">
          {tier.popular && (
        ...
        <div className="rounded-2xl bg-white p-10 pb-9 shadow-2xl ring-1 ring-black/5">
          ...
          <div className="mt-8">
            <Button  href={tier.href}><RocketLaunchIcon/>Essayer la solution</Button>
          </div>
          <div className="mt-8">
...
<Button color={"white"} className={"w-fit"}><EnvelopeIcon/>Contactez nous</Button>
<Button color={"white"} className={"w-fit"}><CalendarIcon/>Planifiez une démo</Button>
                </div>
            </figure>
          </div>
        </div>
