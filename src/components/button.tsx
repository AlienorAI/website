...
const styles = {
  base: [
    ...
    // Focus
    'focus:not-data-focus:outline-hidden  data-focus:outline-2 data-focus:outline-offset-0 data-focus:outline-blue-300',
    // Disabled
  ...
  colors: {
    ...
    red: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-red-500)] [--btn-border:var(--color-red-600)]/90',
      '[--btn-icon:var(--color-red-300)] data-active:[--btn-icon:var(--color-red-200)] data-hover:[--btn-icon:var(--color-red-200)]',
      "data-focus:outline-red-300"
    ],
    orange: [
    ...
    blue: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-blue-500)] [--btn-border:var(--color-blue-400)]/90',
      '[--btn-icon:var(--color-blue-200)] data-active:[--btn-icon:var(--color-blue-100)] data-hover:[--btn-icon:var(--color-blue-100)]',
      "data-focus:outline-blue-300"
    ],
    violet: [
