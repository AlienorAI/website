    ...
    >
      <span
        ...
        className={clsx([
          ...
          'before:absolute before:inset-px before:rounded-[calc(var(--radius-2xl)-1px)] before:bg-white before:shadow-sm',
          // Background color is moved to control and shadow is removed in dark mode so hide `before` pseudo
          'dark:before:hidden',
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-2xl after:ring-inset after:ring-transparent sm:focus-within:after:ring-2 sm:focus-within:after:ring-blue-300',
          // Disabled state
      ...
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            className,
            // Basic layout
            'relative block w-full appearance-none rounded-2xl py-[calc(--spacing(2.5)-1px)] sm:py-[calc(--spacing(1.5)-1px)]',
            // Horizontal padding
      ...
      <Headless.ComboboxOptions
        ...
        className={clsx(
          ...
          // Base styles,
          'isolate min-w-[calc(var(--input-width)+8px)] select-none scroll-py-1 rounded-2xl p-1 empty:invisible',
...
>) {
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        // Basic layout
        'group/option grid w-full cursor-default grid-cols-[1fr_--spacing(5)] items-baseline gap-x-2 rounded-2xl py-2.5 pl-3.5 pr-2 sm:grid-cols-[1fr_--spacing(4)] sm:py-1.5 sm:pl-3 sm:pr-2',
        // Typography
