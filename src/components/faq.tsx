            ...
            {[
                {
                    ...
                    answer: (
                        <>
                            ...
                            vectorielle, base de données, cache, sont hébergées
                            exclusivement en France, dans des centres de données,
                            certifiés{" "}
                            <button
                                onClick={(e) => {
                                    e.preventDefault();
                            ...
                            <br />
                            <br />
                            L'ensemble du traitement est effectué sur des serveurs
                            privés, sécurisés, et 100% français.
                        </>
                    ),
                },
                {
                ...
                {
                    question:
                        "Peut-on supprimer toutes les données si l'on arrête ?",
                    answer:
                        ...
                        <>
                            <ul className="list-disc pl-5">
                                <li>
                                    ...
                                    : vos données ne sont jamais stockées ni utilisées
                                    pour entraîner les modèles. Suppression immédiate
                                    après traitement et hébergement exclusivement en
                                    France.
                                </li>
                                <li>
                                    Mistral AI, modèle français performant, exécuté soit
                                    via API, soit en local sur GPU (offre Business).
                                </li>
                            </ul>
                        </>
                    ),
                },
                {
                    ...
                    answer: (
                        <>
                            Oui, la solution est conçue pour être 100% conforme au
                            RGPD :
                            <ul className="list-disc pl-5">
                                <li>Hébergement en France</li>
                                <li>
                                    Aucune utilisation des données à des fins commerciales
                                    ou d'entraînement
                                </li>
